...
export const SimpleCombobox: React.FC<{
    items: string[]
    ...
    className?: string
    multiple?: boolean
}> = ({ items, value, onChange, placeholder, className, multiple }) => {
    return <Combobox multiple={multiple} items={items} onValueChange={e => onChange(e as any)}>
        <ComboboxInput className={className} placeholder={placeholder} value={value ?? ''} onChange={e => onChange(e.target.value)} />
        <ComboboxContent>
