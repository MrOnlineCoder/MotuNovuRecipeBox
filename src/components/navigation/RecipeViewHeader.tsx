import { CheckLineIcon, ChevronLeftCircleIcon, CookingPot, HeartIcon, HeartMinusIcon, ShoppingCartIcon } from "lucide-react"
...
export const RecipeViewHeader: React.FC<{
    ...
    onAddToCart: () => void
    onCook: () => void
}> = ({ isFavorite, onToggleFavorite, onBack, onCook, onAddToCart, isInCart }) => {
